...
-- Drop tables if they exist so the script starts clean
...
INSERT INTO teams (name, description)
VALUES ('Product', 'Product management team');

INSERT INTO users (username, email, full_name, team_id)
VALUES ('alice_dev', '[alice@example.com](mailto:alice@example.com)', 'Alice Smith', 1);

INSERT INTO users (username, email, full_name, team_id)
VALUES ('bob_dev', '[bob@example.com](mailto:bob@example.com)', 'Bob Jones', 1);

INSERT INTO users (username, email, full_name, team_id)
VALUES ('carol_pm', '[carol@example.com](mailto:carol@example.com)', 'Carol White', 2);
